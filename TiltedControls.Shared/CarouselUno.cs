...
namespace TiltedControls
{
    ...
    /// </remarks>
    public class CarouselUno : ContentControl, ICarousel
    {
        ...
        FrameworkElement AddCarouselItemToUI(int idx)
        {
            ...
            {
                throw new Exception("Failed to create CarouselUno Item");
            }
            return itemElement;
        }
        ...
        //public static readonly DependencyProperty HitboxProperty = DependencyProperty.Register(nameof(Hitbox), typeof(Canvas), typeof(CarouselUno),
        ...
        public static readonly DependencyProperty UseGesturesProperty = DependencyProperty.Register(nameof(UseGestures), typeof(bool), typeof(CarouselUno),
        new PropertyMetadata(true, new PropertyChangedCallback((s, e) =>
        {
            var control = s as CarouselUno;
            control.Refresh();
        })));
        ...
        public static readonly DependencyProperty ItemsSourceProperty = DependencyProperty.Register(nameof(ItemsSource), typeof(object), typeof(CarouselUno),
        ...
        public static readonly DependencyProperty ItemTemplateProperty = DependencyProperty.Register(nameof(ItemTemplate), typeof(DataTemplate), typeof(CarouselUno),
        ...
        public static readonly DependencyProperty ItemContentStyleProperty = DependencyProperty.Register(nameof(ItemContentStyle), typeof(Style), typeof(CarouselUno),
            new PropertyMetadata(null, OnCaptionPropertyChanged));
        ...
        public static readonly DependencyProperty SelectedIndexProperty = DependencyProperty.Register(nameof(SelectedIndex), typeof(int), typeof(CarouselUno),
    new PropertyMetadata(0, OnSelectedIndexChanged));
        ...
        public static readonly DependencyProperty SelectedItemForegroundBrushProperty = DependencyProperty.Register(nameof(SelectedItemForegroundBrush), typeof(Brush), typeof(CarouselUno),
            new PropertyMetadata(null, OnCaptionPropertyChanged));
        ...
        public static readonly DependencyProperty TriggerSelectionAnimationProperty = DependencyProperty.Register(nameof(TriggerSelectionAnimation), typeof(object), typeof(CarouselUno),
            new PropertyMetadata(null, new PropertyChangedCallback((s, e) =>
            {
                if (e.NewValue != null)
                {
        ...
        public static readonly DependencyProperty NavigationSpeedProperty = DependencyProperty.Register(nameof(NavigationSpeed), typeof(int), typeof(CarouselUno),
        ...
        /// <summary>
        /// For CarouselUno configurations with overlapping items. When this is disabled, the ZIndex of items update immediately upon interaction. 
        ...
        public static readonly DependencyProperty ZIndexUpdateWaitsForAnimationProperty = DependencyProperty.Register(nameof(ZIndexUpdateWaitsForAnimation), typeof(bool), typeof(CarouselUno),
        ...
        public static readonly DependencyProperty SelectedItemScaleProperty = DependencyProperty.Register(nameof(SelectedItemScale), typeof(double), typeof(CarouselUno),
        ...
        public static readonly DependencyProperty AdditionalItemsToScaleProperty = DependencyProperty.Register(nameof(AdditionalItemsToScale), typeof(int), typeof(CarouselUno),
        ...
        public static readonly DependencyProperty AdditionalItemsToWarpProperty = DependencyProperty.Register(nameof(AdditionalItemsToWarp), typeof(int), typeof(CarouselUno),
            new PropertyMetadata(4, OnCaptionPropertyChanged));

        /// <summary>
        /// Sets the type of CarouselUno. Chose a Column, a Row, or a Wheel.
        /// </summary>
        ...
        public static readonly DependencyProperty CarouselTypeProperty = DependencyProperty.Register(nameof(CarouselType), typeof(CarouselTypes), typeof(CarouselUno),
        ...
        public static readonly DependencyProperty WheelAlignmentProperty = DependencyProperty.Register(nameof(WheelAlignment), typeof(WheelAlignments), typeof(CarouselUno),
        ...
        public static readonly DependencyProperty DensityProperty = DependencyProperty.Register(nameof(Density), typeof(int), typeof(CarouselUno),
        ...
        public static readonly DependencyProperty FliptychDegreesProperty = DependencyProperty.Register(nameof(FliptychDegrees), typeof(double), typeof(CarouselUno),
        ...
        public static readonly DependencyProperty WarpIntensityProperty = DependencyProperty.Register(nameof(WarpIntensity), typeof(int), typeof(CarouselUno),
        new PropertyMetadata(0, OnCaptionPropertyChanged));
        ...
        public static readonly DependencyProperty WarpCurveProperty = DependencyProperty.Register(nameof(WarpCurve), typeof(double), typeof(CarouselUno),
        ...
        public static readonly DependencyProperty ItemGapProperty = DependencyProperty.Register(nameof(ItemGap), typeof(int), typeof(CarouselUno),
        new PropertyMetadata(0, OnCaptionPropertyChanged));
        ...
        public static readonly DependencyProperty SelectNextTriggerProperty = DependencyProperty.Register(nameof(SelectNextTrigger), typeof(object), typeof(CarouselUno),
        new PropertyMetadata(null, new PropertyChangedCallback((s, e) =>
        {
            if (e.NewValue != null)
            {
        ...
        public static readonly DependencyProperty SelectPreviousTriggerProperty = DependencyProperty.Register(nameof(SelectPreviousTrigger), typeof(object), typeof(CarouselUno),
        new PropertyMetadata(null, new PropertyChangedCallback((s, e) =>
        {
            if (e.NewValue != null)
            {
        ...
        public static readonly DependencyProperty ManipulationStartedTriggerProperty = DependencyProperty.Register(nameof(ManipulationStartedTrigger), typeof(object), typeof(CarouselUno),
        new PropertyMetadata(null, new PropertyChangedCallback((s, e) =>
        {
            if (e.NewValue != null)
            {
        ...
        public static readonly DependencyProperty ManipulationCompletedTriggerProperty = DependencyProperty.Register(nameof(ManipulationCompletedTrigger), typeof(object), typeof(CarouselUno),
        new PropertyMetadata(null, new PropertyChangedCallback((s, e) =>
        {
            if (e.NewValue != null)
            {
        ...
        /// <summary>
        /// Use a ManipulationDelta event to update this value to control the CarouselUno with a dragging gesture or analog stick of a gamepade.
        ...
        public static readonly DependencyProperty CarouselRotationAngleProperty = DependencyProperty.Register(nameof(CarouselRotationAngle), typeof(float), typeof(CarouselUno),
            new PropertyMetadata(null, new PropertyChangedCallback((s, e) =>
            {
                var control = s as CarouselUno;
        ...
        public static readonly DependencyProperty CarouselPositionYProperty = DependencyProperty.Register(nameof(CarouselPositionY), typeof(double), typeof(CarouselUno),
            new PropertyMetadata(null, new PropertyChangedCallback((s, e) =>
            {
                var control = s as CarouselUno;
        ...
        public static readonly DependencyProperty CarouselPositionXProperty = DependencyProperty.Register(nameof(CarouselPositionX), typeof(double), typeof(CarouselUno),
            new PropertyMetadata(null, new PropertyChangedCallback((s, e) =>
            {
                var control = s as CarouselUno;
                if (control._inputAllowed && control.IsCarouselMoving && e.NewValue is double v)
        ...
        /// <summary>
        /// For better performance it may be worth extending CarouselUno and overriding this method with one that targets the specific class and property you want.
        /// </summary>
        ...
        /// <summary>
        /// This must be called before updating the CarouselUno with a ManipulationData event. MMVM implementations can use the trigger property to call it.
        /// </summary>
        ...
        /// <summary>
        /// This must be called after updating the CarouselUno with a ManipulationData event. MMVM implementations can use the trigger property to call it.
        /// </summary>
        ...
        FrameworkElement CreateCarouselItemElement(int i, int playlistIdx)
        {
            if (ItemTemplate != null)
            {
                ...
                if (w == 0 || h == 0)
                {
                    Trace.WriteLine("Tilted CarouselUno: Item Height and Width (or MaxHeight and MaxWidth) not set.");
                }
        ...
        /// <summary>
        /// Raises when the CarouselUno items are loaded into the visual tree.
        /// </summary>
        ...
        private static void OnSelectedIndexChanged(DependencyObject dependencyObject, DependencyPropertyChangedEventArgs e)
        {
            ...
            {
                var control = dependencyObject as CarouselUno;
